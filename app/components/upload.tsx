type UploadProps = {
  ...
  return (
    <div className="w-full h-full bg-black/50 dark:bg-white/50 absolute flex items-center justify-center z-10 top-0">
        <div className="will-change-contents p-10 border-4 border-blue-200 rounded-2xl bg-white text-black dark:bg-black dark:text-white relative">
        <button className="top-2 right-2 absolute rounded-full bg-red-500 text-white w-6" onClick={onClose}>
            X
        </button>
